    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight">AllotWise</h1>
          <p className="text-slate-400 mt-1 text-sm">IPO Portfolio Management</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="admin@allotwise.com"
                required
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition shadow-lg shadow-blue-600/30 mt-2"
            >
          ...
          <div className="mt-6 pt-5 border-t border-white/10">
            ...
            <div className="space-y-1.5 text-xs text-slate-400">
              <div className="flex justify-between p-2 rounded bg-white/5">
                <span>Admin</span>
                <span className="font-mono">admin@allotwise.com / admin123</span>
              </div>
              <div className="flex justify-between p-2 rounded bg-white/5">
                <span>Partner</span>
                <span className="font-mono">partner@allotwise.com / partner123</span>
              </div>
            </div>
          </div>
        </div>
